...
#     artist = db.Column(db.String(255), index=True, nullable=True)
#     album = db.Column(db.String(255), index=True, nullable=True)
#     genre = db.Column(db.String(100), index=True, nullable=True)
#     duration = db.Column(db.Float, nullable=True)
#     year = db.Column(db.Integer, nullable=True)
#     trackNumber = db.Column(db.Integer, nullable=True)
#     bitrate = db.Column(db.Integer, nullable=True)
#     lastUpdated = db.Column(db.DateTime, default=datetime.utcnow)
#     images = db.relationship('AlbumArt', backref='track', lazy=True)
